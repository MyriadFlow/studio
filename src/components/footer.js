      ...
      <footer style={{ background: 'linear-gradient(90deg, #30D8FF 0%, #A32CC4 50%, #C243FE 100%)', padding: '40px 60px' }}>
        <section style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          ...
          <div className="links" style={{ textAlign: 'left', color: 'white', fontSize: '14px' }}>
            ...
            <Link href="/MyriadFlow_Privacy_Policy.pdf" target="_blank" style={{ color: 'white', textDecoration: 'none', display: 'block' }}>
              Privacy Policy
            </Link>
            <Link href="/MyriadFlow_Community_Guidelines.pdf" target="_blank" style={{ color: 'white', textDecoration: 'none', display: 'block' }}>
